...
make -s
cp u-boot-db88f6192abp_200db_flash.bin ../images/DB-6192A-BP/LE/SPI+NAND
cp u-boot-db88f6192abp_200db_uart.bin ../images/DB-6192A-BP/LE/SPI+NAND
...
make -s
cp u-boot-db88f6192abp_200db_flash.bin ../images/DB-6192A-BP/BE/SPI+NAND
cp u-boot-db88f6192abp_200db_uart.bin ../images/DB-6192A-BP/BE/SPI+NAND
