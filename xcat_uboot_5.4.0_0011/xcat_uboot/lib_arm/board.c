...
extern int mvFlash_init (void);
int mvBoardErrataInit(void);
...
init_fnc_t *init_sequence[] = {
    ...
    mvBoardErrataInit,
#if defined(CONFIG_MARVELL) && !defined (MV_NAND_BOOT)
    mvFlash_init,
#endif
...
void start_armboot (void)
{
	...
	/* size += mvFlash_init (); */
#endif
//	display_flash_config (CFG_APPL_FLASH_SIZE);
#endif /* CFG_NO_FLASH */
...
#	endif
	...
	#ifndef MV_SPI
	/*
	 * In case of SPI image with NAND flash access enabled:
	 * defer nand_init(), because JP11 (Chip Select) should be set manually
	 * to [2,3] before the function.
	 */
	puts ("NAND:");
