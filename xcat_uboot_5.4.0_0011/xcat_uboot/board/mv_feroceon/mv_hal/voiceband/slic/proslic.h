...
#define	INIT_DR36	0x00	//	36 0x24 0x00 Initialization OSC1 Active Low Byte (125 s/LSB)
...
#define	INIT_DR40	0x00	//	40 0x28 0x00 Initialization OSC2 Active Low Byte (125 s/LSB)
...
#define	INIT_DR45	0x00	//	45 0x2D 0x00 Initialization Pulse Metering Active High Byte (125 s/LSB)
...
#define	INIT_DR64	0x00	//	64 0x40 0x00 Normal Oper. Mode Byteprimary control
...
#define	INIT_DR73	0x02	//	73 0x49 0x02 Initialization Common Mode VoltageVCM = 3 V(1.5 V/LSB)
...
#define	INIT_DR92	0xff    // MA 0x7f	//	92 0x5C  7F Initialization DCDC Converter PWM Period (61.035 ns/LSB)
#define	INIT_DR93	0x0c    // MA 0x14	//	93 0x5D 0x14 0x19 Initialization DCDC Converter Min. Off Time (61.035 ns/LSB)
...
#define INIT_SI3210M_DR92 0x60  //  92 0x60 Initialization DCDC Converter PWM Period (61.035 ns/LSB)
