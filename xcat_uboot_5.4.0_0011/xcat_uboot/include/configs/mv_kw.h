...
/************/
#ifdef MV_TINY_IMAGE
#define CONFIG_IDENT_STRING	" Marvell version: 5.4.0-TINY"
#else
#define CONFIG_IDENT_STRING	" Marvell version: 5.4.0_00011"
#endif /* MV_TINY_IMAGE */
/* version number passing when loading Kernel */
/* NOTE: last byte is used for boardID on Linux boot time.
 * must be zeroed here 						*/
#define VER_NUM 0x04000000           /* 4.0 */
...
/*****************************************/
/* enable L1 I-cache on early boot stage */
/*****************************************/
#undef MV_EARLY_I_CACHE_ENABLE
...
/*
 * When compiled with '-g -O0' flags, image size is bigger, ==> leave sufficient
 * space for both cases.
 */
#define CFG_MALLOC_BASE      (TEXT_BASE + 0x400000 /* 4M */)
...
#define	CFG_MALLOC_LEN	(8*1024*1024)	/* (default) Reserve 8MB for malloc*/
...
#define	CFG_PROMPT	"Monitor>> "	/* Monitor Command Prompt	*/
#define	CFG_CBSIZE	1024		/* Console I/O Buffer Size	*/
#define	CFG_PBSIZE (CFG_CBSIZE+sizeof(CFG_PROMPT)+16) /* Print Buffer Size */
#define CONFIG_BOOTCOMMAND    "ledinit; bootm 0xf80C0000"
//#define CONFIG_BOOTCOMMAND	"cp.b 0xf80C0000 0x03000000 0x00180000; bootm 0x03000000"
...
#define CONFIG_IPADDR		192.168.19.2
#define CONFIG_SERVERIP		192.168.19.3
#define CONFIG_NETMASK		255.255.255.0
#endif

#define ETHADDR          	"00:00:00:00:51:81"
#define ETH1ADDR          	"00:00:00:00:51:82"
#define ENV_ETH_PRIME			"ppsdma"
...
/* auto boot*/
#define CONFIG_BOOTDELAY	0 		/* by default no autoboot */
...
#if defined (MV_USB) || defined (MV_TINY_IMAGE) || defined(__BE)
 #undef CONFIG_SK98			/* yukon */
...
#define MONITOR_HEADER_LEN	0x200
 ...
 #else
/*  	#define CFG_MONITOR_LEN			(512 << 10)TODO - Haim Remove	*//* Reserve 512 kB for Monitor */
        #define CFG_MONITOR_LEN			(768 << 10)	/* Reserve 768 kB for Monitor */
 #endif
...
#elif defined(MV_SPI_SIZE_AUTO_DETECT)
 #if defined(MV_TINY_IMAGE)
        #define CFG_MONITOR_LEN			(256 << 10)	/* Reserve 252 kB for Monitor */
 #else
        #define CFG_MONITOR_LEN			(768 << 10)	/* Reserve 768 kB for Monitor */
 ...
 #define CFG_ENV_SECT_SIZE			get_sector_size()
#endif
...
#define CFG_ENV_OFFSET				(768 << 10)	/* environment starts here  */
...
#define	CFG_MONITOR_LEN				(768 << 10)	/* Reserve 768KB for Monitor */
...
#ifndef __ASSEMBLY__
extern int calc_flash_size;
#endif

#ifdef MIXED_64K_256K_SECTOR_SIZE
#undef CFG_ENV_ADDR
#undef CFG_ENV_SECT_SIZE
#define CFG_ENV_ADDR          (0xf80c0000)
#define CFG_ENV_SECT_SIZE			0x40000
#endif

/* #define CFG_APPL_FLASH_SIZE (calc_flash_size) */
#if defined(MV_NAND_BOOT)
  /* #define CFG_APPL_FLASH_SIZE 0x100000*128 */
  #define CFG_APPL_FLASH_SIZE (calc_flash_size)
#else
  /* #define CFG_APPL_FLASH_SIZE BOOTDEV_CS_SIZE */
  #define CFG_APPL_FLASH_SIZE (calc_flash_size)
#endif  

#define CFG_APPL_PARTITIONS_NAME  "Linux/vxWorks"
#define CFG_APPL_PART_UBOOT_START (CFG_MONITOR_BASE)
#define CFG_APPL_PART_UBOOT_SIZE  (0x00100000)

#define CFG_APPL_PART_KERNEL_START (CFG_MONITOR_BASE + CFG_APPL_PART_UBOOT_SIZE)

#if defined(MV_NAND_BOOT)
#define CFG_APPL_PART_KERNEL_SIZE  (0x00200000) // 2M
#else
#define CFG_APPL_PART_KERNEL_SIZE  (0x001C0000) // 1.8M
#endif

#define CFG_APPL_PART_ROOTFS_START (CFG_APPL_PART_KERNEL_START + CFG_APPL_PART_KERNEL_SIZE)

#define CFG_APPL_PART_ROOTFS_SIZE  (CFG_APPL_FLASH_SIZE - (CFG_APPL_PART_KERNEL_SIZE + CFG_APPL_PART_UBOOT_SIZE)) // the rest
